  ...
  return (
    <main className="w-[100%] h-[100%] px-4 md:w-[95%] md:h-auto md:h-[95%] md:min-h-[95%] py-6 md:px-8 rounded bg-black">
      <div className="md:flex items-center justify-between mb-10">
        <h1 className="text-2xl mb-5 md:mb-0">Playlist <span className="text-base">- Confira a seguir a lista das playlists disponíveis.</span></h1>
        <Button text="Adicionar" rounded onClick={() => navigate('/playlist/create')}>
